...
if __name__ == '__main__':
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    for step in range(iters_per_epoch):
      ...
      RCNN_loss_cls, RCNN_loss_bbox, RCNN_loss_dim_orien, RCNN_loss_kpts, rois_label, aa=\
    ...
    save_name = os.path.join(output_dir, 'stereo_rcnn_{}_{}_rand2.pth'.format(epoch, step))
    save_checkpoint({
      'epoch': epoch + 1,
